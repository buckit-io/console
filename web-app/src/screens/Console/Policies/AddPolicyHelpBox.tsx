      ...
      <Box sx={{ fontSize: "14px", marginBottom: "15px" }}>
        <Box sx={{ paddingBottom: "20px" }}>
          ...
          <Box sx={{ paddingTop: "20px" }}>
            Buckit uses Policy-Based Access Control (PBAC) to define the
        ...
        <Box sx={{ paddingBottom: "20px" }}>
          Buckit PBAC is built for compatibility with AWS IAM policy syntax,
          structure, and behavior.
        </Box>
        <Box sx={{ paddingBottom: "20px" }}>
          Each user can access only those resources and operations which are
          explicitly granted by the built-in role. Buckit denies access to any
