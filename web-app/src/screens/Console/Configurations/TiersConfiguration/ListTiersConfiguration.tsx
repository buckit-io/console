              ...
              <Fragment>
                  ...
                  <Fragment>
                    ...
                    >
                      <HelpBox
                        ...
                        help={
                          <Fragment>
                            Tiers are used by the Buckit Object Lifecycle
                            Management which allows creating rules for time or
                            date based automatic transition or expiry of
                            objects. For object transition, Buckit automatically
                            ...
                            <a
                              href="https://buckit.sh/docs/administration/object-management/object-lifecycle-management.html"
                              target="_blank"
                              rel="noopener"
                            >
                              documentation
                ...
                {records.length === 0 && (
                  <HelpBox
                    ...
                    help={
                      <Fragment>
                        Tiers are used by the Buckit Object Lifecycle Management
                        which allows creating rules for time or date based
                        automatic transition or expiry of objects. For object
                        transition, Buckit automatically moves the object to a
