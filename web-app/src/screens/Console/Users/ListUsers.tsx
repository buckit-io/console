              ...
              {records.length > 0 && (
                <Fragment>
                  ...
                  <HelpBox
                    ...
                    help={
                      <Fragment>
                        A Buckit user consists of a unique access key (username)
                        ...
                        (password) of an existing Buckit user.
                        <br />
                        ...
                        <br />
                        Buckit uses Policy-Based Access Control (PBAC) to define
                ...
                <Grid container>
                  <Grid item xs={8}>
                    <HelpBox
                      ...
                      help={
                        <Fragment>
                          A Buckit user consists of a unique access key
                          ...
                          through the groups they belong to.
                          <br />
                          Buckit uses Policy-Based Access Control (PBAC) to
                          ...
                          built-in role. Buckit denies access to any other
